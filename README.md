NOTE: After downloading the code from the repository it is necessary to run the npm install command before running it to install all the necessary node modules
